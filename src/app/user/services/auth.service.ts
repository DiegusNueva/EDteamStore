...
export class AuthService {
    ...
    return this.http
      ...
      .pipe(
        tap((response: LoginResponse) => {
          ...
          ); // Almacena el timestamp de expiración
  ...
  // Método para obtener el objeto LoginResponse almacenado en el LocalStorage si no ha expirado
  ...
  // Método para cerrar la sesión (eliminar los valores almacenados)
  logout(): void {
